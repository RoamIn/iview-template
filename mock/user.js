module.exports = {
    '/index.php/userController/query': {
        'method': 'POST',
        'res': () => {
            return {
                'code': 'OK',
    ...
    '/index.php/userController/getInfo': {
        'method': 'GET',
        'res': () => {
            return {
                'code': 'OK',
    ...
    '/index.php/userController/create': {
        'method': 'POST',
        'res': () => {
            return {
                'code': 'OK',
    ...
    '/index.php/userController/update': {
        'method': 'POST',
        'res': () => {
            return {
                'code': 'Failed',
    ...
    '/index.php/userController/getAll': {
        'method': 'GET',
        'res': () => {
            return {
                'code': 'OK',
